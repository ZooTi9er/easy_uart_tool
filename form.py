...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 801, 80))
        ...
        self.open_serial_button = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.open_serial_button.setObjectName("open_serial_button")
        self.horizontalLayout_2.addWidget(self.open_serial_button)
        self.textBrowser = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser.setGeometry(QtCore.QRect(0, 80, 801, 521))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_Com.setItemText(0, _translate("MainWindow", "请重新扫描"))
